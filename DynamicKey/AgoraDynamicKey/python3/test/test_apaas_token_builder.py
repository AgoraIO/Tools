...
class ApaasTokenBuidlerTest(unittest.TestCase):
    def setUp(self) -> None:
        """Create APaaS token fixtures shared by each test."""
    ...
    def test_room_user_token(self):
        """Build and parse an APaaS token with room-user privileges."""
        ...
        services = parser.get_services(ServiceApaas.kServiceType)
    ...
    def test_user_token(self):
        """Build and parse an APaaS token with user privileges."""
    ...
    def test_app_token(self):
        """Build and parse an APaaS token with application privileges."""
