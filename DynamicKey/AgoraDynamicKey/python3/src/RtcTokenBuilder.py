...
class RtcTokenBuilder:
    ...
    @staticmethod
    def buildTokenWithUidUserDefinedPrivilege(appId, appCertificate, channelName, uid, joinChannelPrivilegeExpiredTs,
    ...
    #                    generated, set expireTimestamp as the current 
    @staticmethod
    def buildTokenWithAccountUserDefinedPrivilege(appId, appCertificate, channelName, account,
