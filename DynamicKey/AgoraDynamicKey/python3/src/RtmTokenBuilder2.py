...
class RtmTokenBuilder:
    ...
    def build_token_with_permissions(app_id, app_certificate, user_id, permissions, expire=0):
        ...
        :param app_certificate: Certificate of the application registered in the Agora Dashboard.
        :param user_id: The user's account, max length is 64 bytes.
        :param permissions: The ServiceRtm2.Permissions resource permissions.
