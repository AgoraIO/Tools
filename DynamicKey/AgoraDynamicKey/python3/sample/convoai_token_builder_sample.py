...
def main():
    """Read credentials from environment variables and build a ConvoAI token."""
    app_id = os.environ.get("AGORA_APP_ID")
    app_certificate = os.environ.get("AGORA_APP_CERTIFICATE")
    channel_name = "convoai-channel"
    rtc_account = "convoai-rtc-user"
