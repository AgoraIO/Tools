...
class SimpleTokenBuilder2_test : public testing::Test {
 protected:
  virtual void SetUp() {
  ...
  void testSimpleTokenBuilderWithIntUid() {
    {
      std::string token = SimpleTokenBuilder2::buildTokenWithUid(
  ...
  void testSimpleTokenBuilderWithStringUid() {
    {
    std::string token = SimpleTokenBuilder2::buildTokenWithUserAccount(
...
TEST_F(SimpleTokenBuilder2_test, testSimpleTokenBuilderWithZero) {
  testSimpleTokenBuilderWithZero();
}

TEST_F(SimpleTokenBuilder2_test, testSimpleTokenBuilderWithIntUid) {
  testSimpleTokenBuilderWithIntUid();
}

TEST_F(SimpleTokenBuilder2_test, testSimpleTokenBuilderWithStringUid) {
