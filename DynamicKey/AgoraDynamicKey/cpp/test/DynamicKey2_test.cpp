...
void DynamicKey2_test::test_DynamicKey2() {
  ...
  std::string result = agora::tools::DynamicKey2::generate(
      AppID, AppCertificate, channelName, unixTs, randomInt, uid, expiredTs);
  EXPECT_EQ(result,
            "7666966591a93ee5a3f712e22633f31f0cbc8f13970ca35de60c44645bbae8a215"
            "061b3314464554720383bbf528823412731446455471");
}

TEST_F(DynamicKey2_test, test_DynamicKey2) { test_DynamicKey2(); }
