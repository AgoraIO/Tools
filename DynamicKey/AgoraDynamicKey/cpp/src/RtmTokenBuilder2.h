...
inline std::string RtmTokenBuilder2::BuildToken(const std::string& app_id, const std::string& app_certificate, const std::string& user_id,
                                                const ServiceRtm2::Permissions& permissions, uint32_t expire) {
