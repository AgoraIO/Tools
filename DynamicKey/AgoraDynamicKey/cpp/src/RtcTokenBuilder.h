...
class RtcTokenBuilder {
 public:
  ...
  /**
   ...
   @param appCertificate Certificate of the application that you registered in
   the Agora Dashboard.
   @param channelName Unique channel name for the AgoraRTC session in the string
...
inline std::string RtcTokenBuilder::buildTokenWithUid(
    ...
    const std::string& channelName, uint32_t uid, UserRole role,
