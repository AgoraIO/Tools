...
pub fn build_token_with_uid(
    app_id: &str, app_certificate: &str, channel_name: &str, uid: u32, role: Role, token_expire: u32, privilege_expire: u32,
...
pub fn build_token_with_user_account(
    app_id: &str, app_certificate: &str, channel_name: &str, account: &str, role: Role, token_expire: u32, privilege_expire: u32,
) -> Result<String, Box<dyn std::error::Error>> {
...
pub fn build_token_with_uid_and_privilege(
    app_id: &str, app_certificate: &str, channel_name: &str, uid: u32, token_expire: u32, join_channel_privilege_expire: u32, pub_audio_privilege_expire: u32,
    pub_video_privilege_expire: u32, pub_data_stream_privilege_expire: u32,
) -> Result<String, Box<dyn std::error::Error>> {
...
pub fn build_token_with_user_account_and_privilege(
    app_id: &str, app_certificate: &str, channel_name: &str, account: &str, token_expire: u32, join_channel_privilege_expire: u32,
    pub_audio_privilege_expire: u32, pub_video_privilege_expire: u32, pub_data_stream_privilege_expire: u32,
) -> Result<String, Box<dyn std::error::Error>> {
    let mut token = access_token::new_access_token(app_id, app_certificate, token_expire);
...
pub fn build_token_with_rtm(
    ...
    let mut service_rtm = access_token::new_service_rtm(account);
...
// rtc_role: RolePublisher: A broadcaster/host in a live-broadcast profile.
//     RoleSubscriber: An audience(default) in a live-broadcast profile.
...
// return The RTC and RTM token.
pub fn build_token_with_rtm2(
    app_id: &str, app_certificate: &str, channel_name: &str, rtc_account: &str, rtc_role: Role, rtc_token_expire: u32, join_channel_privilege_expire: u32,
    pub_audio_privilege_expire: u32, pub_video_privilege_expire: u32, pub_data_stream_privilege_expire: u32, rtm_user_id: &str, rtm_token_expire: u32,
) -> Result<String, Box<dyn std::error::Error>> {
