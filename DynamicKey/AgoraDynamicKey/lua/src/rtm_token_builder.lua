...
-- expire: The number of seconds from now before the token expires. This value is the whole token expiration
-- and the service privilege expiration. The whole token is invalid after this time.
