...
class RtcTokenBuilder2Test
{
    ...
    public function run()
    {
        ...
        $this->test_buildTokenWithAccount_ROLE_PUBLISHER();
        $this->test_buildTokenWithAccount_ROLE_SUBSCRIBER();
    }
    ...
    public function test_buildTokenWithAccount_ROLE_PUBLISHER()
    {
        $token = RtcTokenBuilder2::buildTokenWithAccount($this->appId, $this->appCertificate, $this->channelName, $this->uidStr, RtcTokenBuilder2::ROLE_PUBLISHER, $this->expire);
        $accessToken = new AccessToken2();
        $accessToken->parse($token);
    ...
    public function test_buildTokenWithAccount_ROLE_SUBSCRIBER()
    {
        $token = RtcTokenBuilder2::buildTokenWithAccount($this->appId, $this->appCertificate, $this->channelName, $this->uidStr, RtcTokenBuilder2::ROLE_SUBSCRIBER, $this->expire);
        $accessToken = new AccessToken2();
        $accessToken->parse($token);
