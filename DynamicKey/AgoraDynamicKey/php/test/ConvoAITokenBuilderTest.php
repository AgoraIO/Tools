...
require_once "../src/ConvoAITokenBuilder.php";
...
class ConvoAITokenBuilderTest
{
    ...
    public function test_buildToken_ROLE_PUBLISHER()
    {
        ...
        Util::assertEqual(0, count($parser->getServices(ServiceConvoAI::SERVICE_TYPE)[0]->privileges));
    }
...
$test = new ConvoAITokenBuilderTest();
$test->run();
