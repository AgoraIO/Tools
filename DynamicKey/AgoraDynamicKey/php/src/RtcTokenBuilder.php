...
class RtcTokenBuilder
{
    ...
    #                    generated, set expireTimestamp as the current 
    #                    timestamp + 600 (seconds)./
    public static function buildTokenWithUidUserDefinedPrivilege($appID, $appCertificate, $channelName, $uid,
                                                                 $joinChannelPrivilegeExpiredTs,
                                                                 $pubAudioPrivilegeExpiredTs, $pubVideoPrivilegeExpiredTs,
                                                                 $pubDataStreamPrivilegeExpiredTs) {
        return RtcTokenBuilder::buildTokenWithAccountUserDefinedPrivilege($appID, $appCertificate, $channelName, $uid,
                                                                          $joinChannelPrivilegeExpiredTs,
                                                                          $pubAudioPrivilegeExpiredTs, $pubVideoPrivilegeExpiredTs,
                                                                          $pubDataStreamPrivilegeExpiredTs);
    }
    ...
    #                    Agora Service within 10 minutes after the token is 
    #                    generated, set expireTimestamp as the current 
    public static function buildTokenWithAccountUserDefinedPrivilege($appID, $appCertificate, $channelName, $userAccount,
                                                                          $joinChannelPrivilegeExpiredTs,
                                                                          $pubAudioPrivilegeExpiredTs, $pubVideoPrivilegeExpiredTs,
                                                                          $pubDataStreamPrivilegeExpiredTs){
        $token = AccessToken::init($appID, $appCertificate, $channelName, $userAccount);
