module AgoraDynamicKey2
  class EducationTokenBuilder
    ...
    #     Agora Service within 10 minutes after the token is generated, set expire as 600(seconds). This value
    #     is the whole token expiration and the service privilege expiration. The whole token is invalid after
    #     this time.
