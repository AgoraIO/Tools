...
func Test_BuildTokenWithUserAccount_RolePublisher(t *testing.T) {
    token, err := BuildTokenWithUserAccount(DataMockAppId, DataMockAppCertificate, DataMockChannelName, DataMockAccount, RolePublisher, DataMockExpire)
    accesstoken.AssertNil(t, err)
...
func Test_BuildTokenWithUserAccount_RoleSubscriber(t *testing.T) {
    token, err := BuildTokenWithUserAccount(DataMockAppId, DataMockAppCertificate, DataMockChannelName, DataMockAccount, RoleSubscriber, DataMockExpire)
    accesstoken.AssertNil(t, err)
