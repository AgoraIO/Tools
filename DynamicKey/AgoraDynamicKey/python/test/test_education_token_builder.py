...
class EducationTokenBuilderTest(unittest.TestCase):
    def setUp(self):
        """Create education token fixtures shared by each test."""
    ...
    def test_room_user_token(self):
        """Build and parse an education token with room-user privileges."""
    ...
    def test_user_token(self):
        """Build and parse an education token with user privileges."""
    ...
    def test_app_token(self):
        """Build and parse an education token with application privileges."""
