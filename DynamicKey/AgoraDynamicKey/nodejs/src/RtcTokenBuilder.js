...
class RtcTokenBuilder {
    ...
    * @return The new Token.
    */
    static buildTokenWithUidUserDefinedPrivilege(appID, appCertificate, channelName, uid, joinChannelPrivilegeExpiredTs,
                                                 pubAudioPrivilegeExpiredTs, pubVideoPrivilegeExpiredTs,
                                                 pubDataStreamPrivilegeExpiredTs) {
        return this.buildTokenWithAccountUserDefinedPrivilege(appID, appCertificate, channelName, uid,
    ...
    * @return The new Token.
    */
    static buildTokenWithAccountUserDefinedPrivilege(appID, appCertificate, channelName, account,
